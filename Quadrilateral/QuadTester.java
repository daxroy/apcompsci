...
public class QuadTester
{
  public static void main(String[] args)
  {
    ...
    if(q1.getS1()==1 && q1.getS2()==1 && q1.getS3()==1 && q1.getS4()==1 && q2.getS1()==1 && q2.getS2()==2 && q2.getS3()==3 && q2.getS4()==4){
      System.out.println("PASSED");
    }else{
    ...
    if(q1.toString().equals("Quadrilateral Sides 1,1,1,1; Perimeter = 4") && q2.toString().equals("Quadrilateral Sides 1,2,3,4; Perimeter = 10"))
    {
      System.out.println("PASSED");
    }else{
      System.out.println("FAILED!!!");
      System.out.println("Expected output: Quadrilateral Sides 1,1,1,1; Perimeter = 4");
      System.out.println("Your output:" + q1);
      System.out.println("Expected output: Quadrilateral Sides 1,2,3,4; Perimeter = 10");
    ...
    System.out.println("Checking toString() method...");
    if(r1.toString().equals("1x1 Rectangle; Perimeter = 4; Area = 1") && r2.toString().equals("3x4 Rectangle; Perimeter = 14; Area = 12"))
    {
      System.out.println("PASSED");
    }else{
      System.out.println("FAILED!!!");
      System.out.println("Expected output: 1x1 Rectangle; Perimeter = 4; Area = 1");
      System.out.println("Your output:" + r1);
      System.out.println("Expected output: 3x4 Rectangle; Perimeter = 14; Area = 12");
    ...
    System.out.println("Checking toString() method...");
    if(s1.toString().equals("Square with side length 1; Perimeter = 4; Area = 1") && s2.toString().equals("Square with side length 3; Perimeter = 12; Area = 9"))
    {
      System.out.println("PASSED");
    }else{
      System.out.println("FAILED!!!");
      System.out.println("Expected output: Square with side length 1; Perimeter = 4; Area = 1");
      System.out.println("Your output:" + s1);
      System.out.println("Square with side length 3; Perimeter = 12; Area = 9");
